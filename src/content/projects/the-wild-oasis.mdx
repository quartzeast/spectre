...
date: 12-29-2024
description: Hotel management app - full-featured React web application that allows hotel employees to manage cabins, bookings, and guests.
...
![Screenshot](https://github.com/quartzeast/the-wild-oasis/raw/main/public/thumbnail-preview.png)
